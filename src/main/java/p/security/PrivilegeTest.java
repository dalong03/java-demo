...
import p.security.privilege.PrivilegeFileUtil;


public class PrivilegeTest {

	public static void main(String[] args) {
		System.setProperty("java.security.policy", System.getProperty("user.dir") + "\\target\\classes\\file.policy");
		...
		try {
			...
			File fs = new File("D:\\tmp\\temp2.txt");
			fs.createNewFile();
		} catch (IOException e) {
			e.printStackTrace();
		...
		PrivilegeFileUtil.makeFile("temp3.txt");
		System.out.println();
